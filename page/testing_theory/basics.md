...
答：软件测试的目的在于**发现软件的缺陷和错误**，并对软件质量进行度量和评估，以提高软件的质量。**软件测试的目的是为了找bug，并不是验证软件没有bug**。
...
![](/Users/zhenwenlei/GitBookProject/dev-tester/assets/testing_theory/v.jpg)

测试过程加在开发过程的后半段，比较被动。

W模型：

![](/Users/zhenwenlei/GitBookProject/dev-tester/assets/testing_theory/w.jpg)
